...
const Footer = () => {
  ...
  return (
    <footer className="relative border-t border-white/5 text-gray-400 bg-[#080B12] pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] pointer-events-none -mr-64 -mb-64" />
      ...
      <div className="max-w-[1440px] mx-auto px-8">
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white hover:-translate-y-1 transition-all duration-300 group"
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <button 
            ...
            className="group flex items-center gap-3 text-sm font-bold text-white uppercase tracking-widest hover:text-primary transition-all"
          >
            Back to Top
            <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center group-hover:border-primary group-hover:bg-primary/10 transition-all">
              <FiArrowUp size={16} />
            </div>
          </button>
        </div>
