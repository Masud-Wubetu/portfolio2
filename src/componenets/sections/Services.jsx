  ...
  return (
        <section id="services" className="relative py-20 bg-black overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3x" />
                <div className="absolute bottom -1/3 right-0 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3x" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        ...
                        <h2 className="ext-4xl lg:text-5xl font-normal text-white mb-4 max-w-2xl mx-auto ">
