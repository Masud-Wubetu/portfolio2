    ...
    return (
        <section id="testimonials" className="relative py-20 bg-black overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 opacity-20 rounded-full blur-3x" />
            </div>
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-white/60 max-w-xl mx-auto">
                            Empowering clients with design-driven, high-quality solutions buil for success.
                        </p>
                    </div>
                </FadeIn>
                ...
                <FadeIn delay={100}>
                    <div className="relative">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-6 items-stretch ">
                                                ...
                                                <div className="flex-1 flex flex-col justify-between py-4">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div>
                                                            <div className="test-white font-medium mb-1">
                                                                {testimonial.name}
                                                            </div>
                        ...
                        <button
                            ...
                            className="flex absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 rounded-full transition-all duration-300 z-10"
