                    ...
                    {categories.map((category) => (
                        ...
                        >
                            <div className={`absolute inset-0 rounded-full transition-all duration-300 ${activeCategory === category
                                ...
                                : 'bg-white/5 border border-white/10 group-hover:bg-whitr/10'
                            }`} />

                            <div className="relative flex itmes-center gap-2">
                        ...
                        <>
                            <button
                                ...
                                className="flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4
                                           items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm 
                                           border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 
